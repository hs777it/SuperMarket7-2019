...
namespace SuperMarket.Classes
{
    class ClsReturnItems
    {
        ...
        {
            Dt = new DataTable();
            Dt = DAL.SelectData("ReturnItemsMaxId", null);
            //DAL.Close();
            return Dt;
        }
        //----------------------------------------------------------------
        ...
        {
            Dt = new DataTable();
            Dt = DAL.SelectData("GetAllReturnItems", null);
            //DAL.Close();
            return Dt;
        }
        //----------------------------------------------------------------
        ...
        {
            Dt = new DataTable();
            Dt = DAL.SelectData("GetAllReturnSales", null);
            //DAL.Close();
            return Dt;
        }
        //----------------------------------------------------------------
        ...
        public DataTable GatBarCode(string Item_Barcode)
        {
            ...
            Dt = DAL.SelectData("AllReturnItems", param);
            return Dt;
        ...
        public DataTable VerifyReturnSales(string ReturnId)
        {
            ...
            Dt = DAL.SelectData("VerifyReturnSales", param);
            return Dt;
        ...
        public void UpdateReturnSalesQTE(int Item_Id, double Item_Qte)
        {
            ...
            DAL.ExecuteCommand("UpdateReturnSalesQTE", param);
            DAL.Close();
        ...
        public void DeleteReturnSales(int ReturnId)
        {
            ...
            param[0].Value = ReturnId;
            DAL.ExecuteCommand("DeleteReturnSales", param);
            DAL.Close();
        ...
        public void InsertReturnItems(int ReturnId, int Order_Id,
                          ...
                          DateTime Return_Date, string Return_User, string StatusId, string Notes,string ReturnAmouT_Ar,int ItemId)
        {
            ...
            DAL.ExecuteCommand("InsertReturnItems", param);
            DAL.Close();

        }
        //----------------------------------------------------------------

        public void UpdateReturnSales(int ReturnId, int Order_Id,
                          string barcode, string Return_Item, double Return_ItemPrice,
                          double Return_Discount, double Return_QTE, double Return_Total,
                          DateTime Return_Date, string Return_User, string StatusId, string Notes, string ReturnAmouT_Ar, int ItemId)
        {
            ...
            DAL.ExecuteCommand("UpdateReturnSales", param);
            DAL.Close();
        ...
        public DataTable SearchReturnSales(string Criterion)
        {
            ...
            Dt = DAL.SelectData("SearchReturnSales", param);
            DAL.Close();
            return Dt;
        }
    }
